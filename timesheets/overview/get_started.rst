...
| *Rounding up* times up or down to the nearest minutes or hours, when using th timer.
   For example: if the interval is set to 30min, a 14min entry will show up in reports as 0min, and
